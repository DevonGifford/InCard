          ...
          <SheetHeader>
            <SheetDescription className="ml-4">
              ...
              <div className="pt-10 sm:pt-16">
                <h1 className="text-left tracking-wider text-2xl md:text-3xl font-extrabold text-cyan-900 underline underline-offset-8 pb-8">THE 3 PAGES:</h1>
                <div className="flex flex-col gap-6 sm:gap-12 text-xl sm:text-2xl font-bold text-left">
                  {/* HOME PAGE */}
                  <CustomLink source={'/'} title='The Home Page' secure={false} client={false} />
                  {/* LOGIN PAGE */}
                  <CustomLink source={"/auth/signIn"} title='The Sign-In Page' secure={false} client={true} />
                  {/* DASHBOARD PAGE */}
                  <CustomLink source={"/dashboard"} title='The Dashboard Page' secure={true} client={true} />
              ...
              <div className="flex flex-col text-left pt-3 text-xs sm:text-base text-zinc-200">
                ...
                <Link target="_blank" href='https://github.com/DevonGifford/InCard---TechnicalAssaignment'>
                ...
                <Link target="_blank" href='https://www.linkedin.com/in/dbgifford/'>
                  <div className="flex flex-row gap-5 py-2 transition ease-in-out duration-150 hover:scale-110">
                    <Linkedin size={20} />
                    LinkedIn Profile{" "}
                  </div>
