...
const FormFooter = () => {
    ...
    function copyText() {
        navigator.clipboard.writeText("incard")
          .then(() => {
    ...
    return ( 
        <div className="flex flex-col gap-4 sm:gap-7 items-start">
          <span className="pt-1 lg:pt-3 text-incard-blue font-semibold"><Link href="/"> Back to Home Page </Link></span>
          ...
          <div className="flex flex-col gap-1 sm:gap-2  max-w-[400px] bg-gray-800 rounded-xl p-5 text-xs md:text-sm lg:text-base">
            ...
            <span>
              For successfull authentication, you can use the following for both the <strong>username & password</strong>.
            </span>
            <div 
