  ...
  return (
    <div className="flex flex-col justify-center items-center gap-3 mx-5 pt-24 md:pt-36 text-center">
      <h1 className="text-4xl font-bold pb-5">
        Just an <span className="text-incard-blue"> Extra Page</span>
      </h1>
      <h2>
        {" "}
        This page is <em className="text-incard-blue font-bold">viewable</em> if
        you are{" "}
        <em className="text-incard-blue font-bold">authenticated or not</em>
      </h2>
      ...
      <h1 className="text-2xl pt-10 font-bold">
        <span className="text-incard-blue">While you are here</span>, check out
        my portfolio
      </h1>
      <div className="flex flex-row gap-14 pt-10 justify-evenly text-center items-center pb-16">
        <Link
          ...
          target="_blank"
          className="hover:text-incard-blue/70 text-center justify-center items-center hover:-translate-y-2"
        >
          <TbWorldWww size={35} />
        </Link>
        <Link
